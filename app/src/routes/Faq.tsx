  ...
  },
  {
    ...
    content: (
      <p>
        ...
        the fairness, transparency, and best representation of bean payout that
        maps to Netrunner. Treat this current season, more of a beta period
        while we observe how a full competitive season plays out.
        <Sep className={"mt-4"} />
