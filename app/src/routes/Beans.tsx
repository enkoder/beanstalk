...
export function Beans() {
  return (
    <div className={clsx("mx-4 mt-4 flex h-[100svh] flex-col overflow-auto")}>
      ...
      <article className={"text-gray-400"}>
        ...
        <p className={"pl-2"}>
          ...
          Leveraging the ideas behind this principle, it led me to lean towards
          a power law function and not pursue linear or some other scaling
          method.
          <hr /> This led me to{" "}
          ...
          flexibility of these values facilitates iterative adjustments to find
          the optimal balance.
          <hr />
          After plenty of tuning and looking at tournament payouts, I landed on
          top 33% receiving 66% of the points. 80/20 ended up being too top
        ...
        <p className={"pl-2"}>
          Of course, everyone want's to win the tournament, but for many, making
          the cut is their goal for the tournament the tournament. It's exciting
          to make the cut and I wanted to create a similar experience for
          winning any amount of points. In a poker tournament, a common term is
          used is "in the money", meaning you're going to be getting something
          back for your performance in the tournament. It's an important
          mechanic that creates excitement when you receive any points, and we
          wanted to incorporate that at Beanstalk.
          <hr />
          This value is configurable, but currently the cutoff for being in the
          points is set to 50%, meaning the top half of the tournament will
          receive some amount of points. Everyone else will receive 0 points.
        </p>
        ...
        <p className={"pl-2"}>
          ...
          baseline points correspond to the various tournament types. Expand the
          Coder section below to view the tiered point configuration per
          tournament type
        </p>
        ...
        <p className={"pl-2"}>
          ...
          distribute points fairly, with adjustments based solely on the number
          of players and the baseline points for each tournament type.
          <hr />
