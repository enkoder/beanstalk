...
const SUPPORTED_TOURNAMENT_TYPES: ABRTournamentTypeFilter[] = [
  ...
  ABRTournamentTypeFilter.DistrictChampionship,
  ABRTournamentTypeFilter.MegaCityChampionship,
];
...
async function handleTournamentIngest(
  ...
  if (abrTournament.id === CBI_2024.top_cut.abr_tournament_id) {
    ...
    tournamentBlob = abrToTournament(abrTournament, seasonId, cutTo);
  }
